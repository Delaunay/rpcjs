...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'rpcjs'))
...
project = u'rpcjs'
_full_version = rpcjs.__version__
author = rpcjs.__author__
copyright = rpcjs.__copyright__
...
latex_documents = [
    (master_doc, 'rpcjs.tex', u'rpcjs Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'rpcjs', 'rpcjs Documentation',
     [author], 1)
]
